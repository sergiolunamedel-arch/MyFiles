...
{% macro fix_cell(txt) %}{% if txt %}
  ...
  <div class="fix"><b>🛠 Fix:</b>
    <span class="fix-short">{{ txt[:240] }}<span class="fix-expand" onclick="var p=this.parentNode,f=p.nextElementSibling;p.style.display='none';f.style.display='inline'" title="Ver recomendación completa">… <b style="font-size:10px">▼ ver más</b></span></span>
    <span class="fix-full" style="display:none">{{ txt }}<span class="fix-expand" onclick="var f=this.parentNode,p=f.previousElementSibling;f.style.display='none';p.style.display='inline'" title="Colapsar"> <b style="font-size:10px">▲ colapsar</b></span></span>
  </div>
